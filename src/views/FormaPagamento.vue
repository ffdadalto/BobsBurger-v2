        ...
        <div class="container-fluid">
            ...
            <template v-if="listaFitrada.length > 0">
                <DataTable :value="listaFitrada" v-model:selection="selectedObjs" dataKey="id" :paginator="true"
                    ...
                    <Column field="taxa" header="Taxa" :sortable="true" style="min-width:8rem"></Column>
            ...
            <Dialog v-model:visible="objDialog" :style="{ width: '550px' }" :header="`Cadastro de ${objSingular}`"
                ...
                <div class="row">
                    ...
                    <div class="field col-4">
                        <label>Taxa</label>
                        <InputText v-model.trim="obj.taxa" required="true" autofocus :class="{
                            'p-invalid': submitted && !obj.taxa,
                        }" />
                        <small class="p-error" v-if="submitted && !obj.taxa">Campo Obrigatório.</small>
                    </div>
...
const objSingular = ref('pagamento');
const objPlural = ref('pagamentos');
